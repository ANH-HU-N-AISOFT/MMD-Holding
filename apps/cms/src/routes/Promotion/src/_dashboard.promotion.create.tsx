  ...
  try {
    ...
    if (data) {
      await createPromotion({
        ...
        feeDiscount: data.type === PromotionType.FeeDiscount ? data.promotionByMoney : null,
        giftDiscount: data.type === PromotionType.Gift ? data.promotionByGift ?? null : null,
        name: data.name,
        notes: data.note ?? null,
        organizationIds: data.departments ?? null,
        percentageDiscount: data.type === PromotionType.PercentageDiscount ? data.promotionByMoney : null,
