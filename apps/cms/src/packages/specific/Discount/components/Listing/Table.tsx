...
export const Table = ({
  ...
  const columns: ListingColumnType<Discount>[] = [
    // {
    //   width: 70,
    //   title: (
    ...
    {
      width: 220,
      title: t('discount:date_available'),
    },
    {
      width: 80,
      align: 'center',
        ...
        return (
          <TableActions
            items={[
              ...
              {
                key: '2',
                label: t('discount:view'),
                icon: <EyeOutlined />,
                onClick: () => onView?.(record),
              },
              {
                key: '3',
                label: t('discount:delete'),
                icon: <DeleteOutlined />,
                danger: true,
    ...
    <>
      ...
      <SickyAction isVisible={!!selectedRows.length}>
        <div className="min-w-[400px] flex items-center justify-between">
          <Highlighter
            textToHighlight={t('discount:total_records_selected', {
