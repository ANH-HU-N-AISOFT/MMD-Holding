...
export const isGet = (request: Pick<Request, 'method'>) => request.method === 'GET' || request.method === 'get';
 ...
 */
export const getValidatedFormData = async <T extends FieldValues>(request: Request, resolver: Resolver) => {
 ...
 */
export const validateFormData = async <T extends FieldValues>(data: any, resolver: Resolver) => {
