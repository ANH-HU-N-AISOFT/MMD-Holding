...
| selectedKey      | `string \| undefined`                                                                                              | Yes      | -       | The keys of the currently selected node.                                            |
...
| onSelect         | (key: `undefined \| string`, option: `undefined \| Omit<Leaf<Model>, 'disabled' \| 'hidden' \| 'parent'>`) => void | Yes      | -       | Callback function triggered when a node's selected state changes.                   |
...
export const Sample = () => {
  ...
  return (
    <div>
      ...
      <TreeSelectSingle data={data} selectedKey={selectedKey} onSelect={setSelectedKey} />
    </div>
  );
};
...
| className        | string                                                                                                                        | Yes      | -       | Custom CSS class for styling the tree component.                                    |
| data             | `Leaf<Model>[]`                                                                                                               | No       | -       | The array of leaf nodes that make up the tree data.                                 |
| selectedKeys     | string[]                                                                                                                      | Yes      | -       | The keys of the currently selected nodes.                                           |
| disabled         | boolean                                                                                                                       | Yes      | -       | Whether the entire tree is disabled.                                                |
| height           | number                                                                                                                        | Yes      | -       | The height of the tree component.                                                   |
| defaultExpandAll | boolean                                                                                                                       | Yes      | -       | Whether to expand all treeNodes by default.                                         |
| onSelect         | (keys: `string[] \| undefined`, options: `undefined \| Array<Omit<Leaf<Model>, 'disabled' \| 'hidden' \| 'parent'>>`) => void | Yes      | -       | Callback function triggered when a node's selected state changes.                   |
| iconExpand       | (props: { expanded: boolean }) => ReactNode                                                                                   | Yes      | -       | Customize expand/collapse icons for tree nodes (With default rotate angular style). |
